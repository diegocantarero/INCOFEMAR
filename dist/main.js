...
// main.txt
function buildDefaultDevices(peopleArr) {
  const byName = (n) => peopleArr.find((p) => (p.name || "").toLowerCase() === n.toLowerCase());
  const map = {};
  const am = byName("Amilcar");
...
function buildDefaultContacts(peopleArr) {
  const map = {};
  for (const p of peopleArr) {
    const seed = DIRECTORY_DEFAULT.find((d) => d.name.toLowerCase() === (p.name || "").toLowerCase());
    map[p.id] = { phone: (seed == null ? void 0 : seed.phone) || "", operator: (seed == null ? void 0 : seed.operator) || "Claro Prepago" };
  }
  return map;
}
function IncofemarComparativa() {
  const [people, setPeople] = (0, import_react.useState)(INITIAL_PEOPLE);
  const [dark, setDark] = (0, import_react.useState)(true);
  const [mobilePlan, setMobilePlan] = (0, import_react.useState)("Claro Empresarial");
  const [branches, setBranches] = (0, import_react.useState)(INITIAL_BRANCHES);
  const [devicesByPerson, setDevicesByPerson] = (0, import_react.useState)({});
  const [planByPerson, setPlanByPerson] = (0, import_react.useState)({});
  const [contactsByPerson, setContactsByPerson] = (0, import_react.useState)({});
  ...
  const saveDebounce = import_react.default.useRef(null);
  ...
  async function saveRemote(state) {
    try {
      ...
      if (!token) return;
      const { owner, repo, branch, statePath } = REPO_INFO;
      let sha = void 0;
      ...
      const body = { message: "Update state.json (via app)", content, branch, sha };
      ...
      if (!put.ok) {
        try {
          console.warn("saveRemote error", await put.text());
        } catch (e) {
        }
      }
    } catch (e) {
      console.warn("saveRemote exception", e);
    }
  }
        ...
        try {
          ...
          if (raw) {
            ...
            if (Array.isArray(p.branches) && p.branches.length) {
              const normalized = p.branches.map((b) => {
            ...
            if (p.mobilePlan) setMobilePlan(p.mobilePlan === "Personal" ? "Actual" : p.mobilePlan);
            if (p.devicesByPerson) setDevicesByPerson(p.devicesByPerson);
            if (p.planByPerson) setPlanByPerson(p.planByPerson);
            if (p.contactsByPerson) setContactsByPerson(p.contactsByPerson);
          }
  ...
  (0, import_react.useEffect)(() => {
    ...
    setContactsByPerson((prev) => {
      ...
      for (const p of people) {
        if (!(p.id in next)) {
          const seed = DIRECTORY_DEFAULT.find((d) => (d.name || "").toLowerCase() === (p.name || "").toLowerCase());
          next[p.id] = { phone: (seed == null ? void 0 : seed.phone) || "", operator: (seed == null ? void 0 : seed.operator) || "Claro Prepago" };
          changed = true;
        }
      }
      return changed ? next : prev;
  ...
  }, [hydrated, people, dark, branches, mobilePlan, devicesByPerson, planByPerson, contactsByPerson]);
  ...
  const directoryRows = (0, import_react.useMemo)(() => {
    return people.map((p) => {
      var _a;
      const seed = DIRECTORY_DEFAULT.find((d) => (d.name || "").toLowerCase() === (p.name || "").toLowerCase());
      const contact = contactsByPerson[p.id] || { phone: (seed == null ? void 0 : seed.phone) || "", operator: (seed == null ? void 0 : seed.operator) || "Claro Prepago" };
      const devices = devicesByPerson[p.id] || [];
      const planTier = planByPerson[p.id] || "Bss S";
      const sinISV = (_a = PLAN_BASE_SIN_ISV[planTier]) != null ? _a : 0;
  ...
  const addPerson = (0, import_react.useCallback)(() => {
    const id = makeId();
    setPeople((prev) => {
      const newP = { id, name: `Persona ${prev.length + 1}` };
      setPlanByPerson((prevPlan) => ({ ...prevPlan, [id]: "Bss S" }));
  ...
  const removePerson = (id) => {
    ...
    if (!removed) return;
    const prevDevices = { ...(devicesByPerson || {})[id] ? { [id]: devicesByPerson[id] } : {} };
    const prevPlan = planByPerson[id];
    const prevContact = contactsByPerson[id];
    ...
    const restore = () => {
      ...
      if (prevPlan) setPlanByPerson((prev) => ({ ...prev, [id]: prevPlan }));
      if (prevContact) setContactsByPerson((prev) => ({ ...prev, [id]: prevContact }));
    };
    showUndo("person", removed, restore);
  };
  const setSingleDevice = (0, import_react.useCallback)((pid, value) => {
    setDevicesByPerson((prev) => {
      const next = { ...prev };
      if (!value) delete next[pid];
      else next[pid] = [value];
      return next;
    });
  }, []);
  ...
  const handlePrint = () => {
    ...
    if (window.requestIdleCallback) window.requestIdleCallback(trigger, { timeout: 300 });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `min-h-screen w-full ${bgApp}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mx-auto w-full max-w-none p-3 sm:p-4 md:p-6 lg:p-8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "mb-6 flex flex-col gap-2 md:flex-row md:items-end md:justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", { className: "text-3xl font-extrabold tracking-tight", children: [
          "INCOFEMAR \xB7 ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-blue-500", children: "Comparativa Postpago" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              children: dark ? "Tema claro" : "Tema oscuro"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative group", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -top-8 right-0 hidden group-hover:block rounded-md bg-neutral-800 text-white text-xs px-2 py-1 shadow-lg print:hidden", children: "Ctrl + P" })
          ] })
        ] })
      ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: `${card} mt-6 rounded-2xl p-5 shadow-sm`, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "overflow-x-auto mt-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { className: "min-w-full border-separate border-spacing-y-2 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { className: subtle, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-left px-3", children: "Operador" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-left px-3", children: "Nombre" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-left px-3", children: "Tel\xE9fono" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-left px-3", children: "Dispositivo" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-left px-3", children: "Plan" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-right px-3", children: "Sin ISV" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-right px-3", children: "Financ." }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-right px-3", children: "Subtotal" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-right px-3", children: "ISV (15%)" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-right px-3", children: "Total" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "text-right px-3", children: "Acciones" })
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: directoryRows.map((r) => {
            var _a;
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "tr",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "select",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Tigo Prepago" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Claro Prepago" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Claro Postpago" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Claro Postpago + Celular" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Claro Empresarial" })
                      ]
                    }
                  ) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 font-medium", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "input",
                    {
                      value: r.name,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    ...
                    {
                      className: "rounded-xl border px-2 py-1 bg-transparent",
                      value: ((_a = devicesByPerson[r.id]) == null ? void 0 : _a[0]) || "",
                      onChange: (e) => setSingleDevice(r.id, e.target.value || ""),
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "", children: "\u2014" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "Galaxy A16", children: "Galaxy A16" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "Samsung Tab A9", children: "Samsung Tab A9" })
                      ]
                    }
                  ) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "select",
                    {
                      ...
                      onChange: (e) => setPlanByPerson((prev) => ({ ...prev, [r.id]: e.target.value })),
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "Bss S", children: "Bss S" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "Bss 1", children: "Bss 1" }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "Bss 2", children: "Bss 2" })
                      ]
                    }
                  ) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right", children: L(r.sinISV) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right", children: L(r.finance) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right", children: L(r.subtotal) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right", children: L(r.isv) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right", children: L(r.total) }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-end gap-2", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cursor-move select-none opacity-70", children: "\u22EE\u22EE" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                      "button",
                      {
                        type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tfoot", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { className: `${rowBg} rounded-xl`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { colSpan: 6 }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right", children: L(financeTotalsSum) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { colSpan: 2 }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right font-extrabold", children: L(directoryTotalsSum) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "px-3 py-2 text-right print:hidden" })
          ] }) })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-3 flex items-center justify-start text-sm", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            type: "button",
            onClick: addPerson,
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-lg leading-none", children: "\uFF0B" }),
              " A\xF1adir integrante"
            ]
          }
        ) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: `${card} mt-4 rounded-2xl p-4 shadow-sm`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-lg font-semibold", children: "Referencia de planes empresariales" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          SmartImg,
          {
            srcs: [
              "/assets/Postpago.png",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "mt-6 grid gap-4", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${card} rounded-2xl p-4 shadow-sm`, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-3", children: [
          branches.map((b) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-1 md:grid-cols-6 items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Claro" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Tigo" })
                  ]
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "md:col-span-2 flex items-center gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "select",
                  {
                    ...
                    children: list.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: p.key, children: p.key }, p.key))
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-right font-semibold", children: L(selected.price || 0) })
            ] }, b.id);
          }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: `${card} mt-6 rounded-2xl p-4 shadow-sm`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: `text-base font-bold ${subtle}`, children: "Totales combinados" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mb-2 flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: subtle, children: "M\xF3vil" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { value: mobilePlan, onChange: (e) => setMobilePlan(e.target.value), className: "rounded-xl border px-2 py-1 bg-transparent", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Actual" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Claro Personal" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Claro Empresarial" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { children: "Tigo Empresarial" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-2 space-y-1 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "M\xF3vil (del Directorio)" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", { className: `py-10 text-center text-xs ${subtle} print:hidden`, children: "Construido para INCOFEMAR \u2014 persiste con localStorage. Datos en L con ISV." })
    ] }),
...
var import_react, import_jsx_runtime, L, round2, SmartImg, CURRENT_PER_LINE, CLARO_PERSONAL_PER_LINE, CLARO_EMP_PER_LINE, TIGO_PER_LINE, INTERNET_MAP, makeId, INITIAL_PEOPLE, INITIAL_BRANCHES, DIRECTORY_DEFAULT, PLAN_BASE_SIN_ISV, STORAGE_KEY;
var init_main = __esm({
  "main.txt"() {
    import_react = __toESM(require_react());
    import_jsx_runtime = __toESM(require_jsx_runtime());
    L = (n) => `L${Number(n).toLocaleString("es-HN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
    round2 = (n) => Math.round((Number(n) + Number.EPSILON) * 100) / 100;
    SmartImg = import_react.default.memo(function SmartImg2({ srcs, alt, className }) {
      const [i, setI] = import_react.default.useState(0);
      const [fallbackObject, setFallbackObject] = import_react.default.useState(false);
      const shown = srcs[Math.min(i, srcs.length - 1)];
      if (fallbackObject) {
        return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("object", { data: shown, type: "image/png", className, "aria-label": alt || "", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: (shown || "") + (shown.includes("?") ? "&" : "?") + "v=1", alt: alt || "", className }) });
      }
    ...
    CURRENT_PER_LINE = 500;
    CLARO_PERSONAL_PER_LINE = 669;
    CLARO_EMP_PER_LINE = 355.35;
    TIGO_PER_LINE = 510;
    INTERNET_MAP = {
      Claro: [
        ...
        { key: "GPON 130 MB + TV", price: 799 },
        { key: "GPON 130 MB", price: 476 },
        { key: "TV", price: 274 }
      ],
      Tigo: [
        { key: "ONE TV 400 Mbps (incluye TV)", price: 1625 },
        { key: "ONE TV 300 Mbps (Android + DVB)", price: 1130 },
        { key: "ONE TV 300 Mbps (DVB)", price: 885 },
        { key: "Solo Internet 300 Mbps", price: 810 },
        { key: "Solo Internet 300 Mbps Plus", price: 1355 }
      ]
    };
    makeId = () => `${Date.now()}_${Math.random().toString(36).slice(2, 8)}`;
    INITIAL_PEOPLE = [
    ...
    STORAGE_KEY = "incofemar_comp_vs_v6";
  }
});

// shell-scripts/code/mount_entry.tsx
var require_mount_entry = __commonJS({
  "shell-scripts/code/mount_entry.tsx"() {
    ...
    (0, import_client.createRoot)(ensureAppRoot()).render(React2.createElement(IncofemarComparativa));
  }
});
export default require_mount_entry();
